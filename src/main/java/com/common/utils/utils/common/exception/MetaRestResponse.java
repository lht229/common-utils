...
import com.common.utils.utils.common.Page;
...
public final class MetaRestResponse extends HashMap<String, Object> {
    ...
    private MetaRestResponse() {
        this.put(META, new HashMap<Object, Object>());
    }
    ...
    private MetaRestResponse errors(int errorCode, String message) {
        if (!this.containsKey(ERROR)) {
            this.put(ERROR, new HashMap<Object, Object>());
        }
    ...
    public static MetaRestResponse success(int code, Page page, Object object) {
        MetaRestResponse response = new MetaRestResponse();
        response.pagingMeta(code, page.getPageNumber(), page.getTotal(), page.getPageSize());
